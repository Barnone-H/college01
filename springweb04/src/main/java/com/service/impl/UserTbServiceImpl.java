...
public class UserTbServiceImpl  implements UserTbService {
    ...
    public UserTb login(UserTb userTb) {
        ...
        if(userTb1!=null&&userTb1.getUserPs()!=null && userTb1.getUserPs().equals(userTb.getUserPs())) {
    ...
    public int updatepass(UserTb userTb) {
        return userTbMapper.updatepass(userTb);
    }
